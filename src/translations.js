...
const TRANSLATIONS = {
  ...
  de: {
    ...
    confirm_disable_port_message: "Möchtest du {port} wirklich deaktivieren?",
    confirm_yes:        "Ja",
    confirm_no:         "Nein",
    poe_off:            "PoE Aus",
    poe_on:             "PoE Ein",
    ...
    editor_dynamic_port_details_hint:  "Startet ohne ausgewählten Port. Klicke einen Port an, um Details anzuzeigen, und erneut, um sie auszublenden.",
    ...
    editor_default_uplink_port_hint: "Optional. Die automatische und manuelle Auswahl berücksichtigt nur die ausgewiesenen Uplink-Ports des Geräts.",
    editor_default_port_label: "Initialer Port",
    editor_default_port_auto: "Automatisch (aktiver Port)",
    editor_default_port_hint: "Optional. Die automatische und manuelle Auswahl berücksichtigt die Ports des integrierten Switches.",
    ...
    editor_port_led_blink_hint: "Nur ein optionaler optischer Effekt. Portstatus, Verkehrserkennung und Steuerung bleiben unverändert.",
    ...
    editor_colors_back: "Zurück zum Editor",
    editor_colors_apply: "Farben übernehmen",
    editor_colors_step_hint: "Tipp: Klicke auf einen Bereich, um den Color-Picker zu öffnen.",
    editor_colors_reset_slot: "Diese Farbe zurücksetzen",
    editor_colors_reset_all: "Alle Farben zurücksetzen",
  ...
  nl: {
    ...
    editor_default_uplink_port_label: "Initiële uplinkpoort",
    ...
    editor_default_port_label: "Initiële poort",
    editor_default_port_auto: "Automatisch (actieve poort)",
    editor_default_port_hint: "Optioneel. Automatische en handmatige keuzes gebruiken de poorten van de geïntegreerde switch.",
  ...
  fr: {
    ...
    confirm_disable_port_title:   "Désactiver le port ?",
    confirm_disable_port_message: "Voulez-vous vraiment désactiver {port} ?",
    confirm_yes:        "Oui",
    confirm_no:         "Non",
    ...
    editor_dynamic_port_details_label: "Détails de port dynamiques",
    editor_dynamic_port_details_text:  "Afficher les détails à la sélection",
    editor_dynamic_port_details_hint:  "Démarre sans port sélectionné. Cliquez sur un port pour afficher ses détails, puis à nouveau pour les masquer.",
    ...
    editor_default_uplink_port_hint: "Facultatif. Les choix automatiques et manuels utilisent uniquement les ports uplink désignés de l’appareil.",
    editor_default_port_label: "Port initial",
    editor_default_port_auto: "Automatique (port actif)",
    editor_default_port_hint: "Facultatif. Les choix automatiques et manuels utilisent les ports du switch intégré.",
    ...
    editor_port_led_blink_text: "Faire clignoter les voyants des ports connectés",
    ...
    editor_port_led_blink_speed_label: "Fréquence de clignotement (1–10 par seconde)",
    editor_port_led_blink_hint: "Effet visuel facultatif uniquement. L’état des ports, la détection du trafic et les commandes restent inchangés.",
    ...
    editor_colors_back: "Retour à l’éditeur",
    editor_colors_apply: "Appliquer les couleurs",
    editor_colors_step_hint: "Astuce : cliquez sur une zone pour ouvrir le sélecteur.",
    editor_colors_reset_slot: "Réinitialiser cette couleur",
    editor_colors_reset_all: "Réinitialiser toutes les couleurs",
    editor_colors_done: "Terminé",
    editor_colors_alpha_label: "Alpha",
    editor_colors_default_value: "Par défaut",
    editor_color_slot_background: "Arrière-plan",
    editor_color_slot_title: "Titre",
    editor_color_slot_telemetry: "Télémétrie",
    editor_color_slot_label: "Libellés",
    ...
    editor_color_slot_button: "Arrière-plan du bouton",
    editor_color_slot_button_text: "Texte/icône du bouton",
    editor_color_slot_button_secondary: "Arrière-plan du bouton secondaire",
    editor_color_slot_button_secondary_text: "Texte/icône du bouton secondaire",
    editor_color_slot_button_border: "Bordure du bouton",
    editor_button_theme_style_label: "Utiliser les couleurs de bouton du thème",
    editor_button_theme_style_hint: "Utilise les variables du thème Home Assistant pour l’arrière-plan et les couleurs du texte/de l’icône des boutons.",
    editor_button_default_color_label: "Utiliser les couleurs de bouton par défaut",
    editor_button_default_color_hint: "Lorsque les couleurs du thème sont désactivées, conserve les couleurs intégrées des boutons sauf si les couleurs personnalisées sont activées.",
  ...
  es: {
    ...
    confirm_disable_port_title:   "¿Desactivar puerto?",
    confirm_disable_port_message: "¿Seguro que quieres desactivar {port}?",
    confirm_yes:        "Sí",
    confirm_no:         "No",
    poe_off:            "PoE apagado",
    ...
    editor_dynamic_port_details_label: "Detalles de puerto dinámicos",
    editor_dynamic_port_details_text:  "Mostrar detalles al seleccionar",
    editor_dynamic_port_details_hint:  "Comienza sin ningún puerto seleccionado. Haz clic en un puerto para ver sus detalles y otra vez para ocultarlos.",
    ...
    editor_default_uplink_port_auto: "Automático (uplink activo)",
    editor_default_uplink_port_hint: "Opcional. Las opciones automáticas y manuales solo utilizan los puertos uplink designados del dispositivo.",
    editor_default_port_label: "Puerto inicial",
    editor_default_port_auto: "Automático (puerto activo)",
    editor_default_port_hint: "Opcional. Las opciones automáticas y manuales utilizan los puertos del switch integrado.",
    ...
    editor_port_led_blink_label: "Animación LED de enlace de puertos",
    ...
    editor_port_led_blink_hint: "Solo es un efecto visual opcional. El estado de los puertos, la detección de tráfico y los controles no cambian.",
    ...
    editor_color_slot_title: "Título",
    editor_color_slot_telemetry: "Telemetría",
    ...
    editor_color_slot_button: "Fondo del botón",
    editor_color_slot_button_text: "Texto/icono del botón",
    editor_color_slot_button_secondary: "Fondo del botón secundario",
    editor_color_slot_button_secondary_text: "Texto/icono del botón secundario",
    editor_color_slot_button_border: "Borde del botón",
    editor_button_theme_style_label: "Usar colores de botón del tema",
    ...
    editor_button_default_color_label: "Usar colores de botón predeterminados",
    editor_button_default_color_hint: "Cuando los colores del tema están desactivados, mantiene los colores integrados de los botones salvo que estén activados los colores personalizados.",
  ...
  it: {
    ...
    editor_port_led_blink_speed_label: "Velocità di lampeggio (1–10 al secondo)",
...
TRANSLATIONS.sv = {
  ...
  editor_default_uplink_port_hint: "Valfritt. Automatiska och manuella val använder endast enhetens angivna uplink-portar.",
  editor_default_port_label: "Ursprunglig port",
  editor_default_port_auto: "Automatiskt (aktiv port)",
  editor_default_port_hint: "Valfritt. Automatiska och manuella val använder portarna på den integrerade switchen.",
  editor_port_led_blink_label: "Animering av portarnas länklysdioder",
  editor_port_led_blink_text: "Låt länklysdioderna för anslutna portar blinka",
  editor_port_led_blink_rj45_text: "Låt RJ45-länklysdioder blinka",
  editor_port_led_blink_sfp_text: "Låt SFP-länklysdioder blinka",
  editor_port_led_blink_speed_label: "Blinkhastighet (1–10 per sekund)",
  editor_port_led_blink_hint: "Endast en valfri visuell effekt. Portstatus, trafikidentifiering och kontroller påverkas inte.",
...
TRANSLATIONS.da = {
  ...
  editor_default_port_hint: "Valgfrit. Automatiske og manuelle valg bruger portene på den integrerede switch.",
  ...
  editor_port_led_blink_hint: "Kun en valgfri visuel effekt. Portstatus, trafikregistrering og betjening forbliver uændret.",
...
TRANSLATIONS.no = {
  ...
  editor_default_port_auto: "Automatisk (aktiv port)",
  editor_default_port_hint: "Valgfritt. Automatiske og manuelle valg bruker portene på den integrerte switchen.",
...
TRANSLATIONS.fi = {
  ...
  editor_default_uplink_port_hint: "Valinnainen. Automaattiset ja manuaaliset valinnat käyttävät vain laitteen määritettyjä uplink-portteja.",
  editor_default_port_label: "Alkuperäinen portti",
  editor_default_port_auto: "Automaattinen (aktiivinen portti)",
  editor_default_port_hint: "Valinnainen. Automaattiset ja manuaaliset valinnat käyttävät integroidun kytkimen portteja.",
  editor_port_led_blink_label: "Porttien linkki-LEDien animaatio",
  editor_port_led_blink_text: "Vilkuta yhdistettyjen porttien linkki-LEDejä",
  editor_port_led_blink_rj45_text: "Vilkuta RJ45-linkki-LEDejä",
  editor_port_led_blink_sfp_text: "Vilkuta SFP-linkki-LEDejä",
  editor_port_led_blink_speed_label: "Vilkkumisnopeus (1–10 sekunnissa)",
  editor_port_led_blink_hint: "Vain valinnainen visuaalinen tehoste. Porttien tila, liikenteen tunnistus ja ohjaimet eivät muutu.",
...
TRANSLATIONS.pl = {
  ...
  editor_default_uplink_port_hint: "Opcjonalne. Wybór automatyczny i ręczny uwzględnia tylko wyznaczone porty uplink urządzenia.",
  editor_default_port_label: "Port początkowy",
  editor_default_port_auto: "Automatycznie (aktywny port)",
  editor_default_port_hint: "Opcjonalne. Wybór automatyczny i ręczny uwzględnia porty zintegrowanego przełącznika.",
  editor_port_led_blink_label: "Animacja diod połączenia portów",
  editor_port_led_blink_text: "Miganie diod połączenia aktywnych portów",
  ...
  editor_port_led_blink_hint: "Tylko opcjonalny efekt wizualny. Stan portów, wykrywanie ruchu i sterowanie pozostają bez zmian.",
...
TRANSLATIONS.cs = {
  ...
  editor_default_uplink_port_hint: "Volitelné. Automatický a ruční výběr používá pouze určené uplink porty zařízení.",
  editor_default_port_label: "Počáteční port",
  editor_default_port_auto: "Automaticky (aktivní port)",
  editor_default_port_hint: "Volitelné. Automatický a ruční výběr používá porty integrovaného přepínače.",
  editor_port_led_blink_label: "Animace kontrolek připojení portů",
  editor_port_led_blink_text: "Blikání kontrolek připojených portů",
  editor_port_led_blink_rj45_text: "Blikání kontrolek připojení RJ45",
  editor_port_led_blink_sfp_text: "Blikání kontrolek připojení SFP",
  editor_port_led_blink_speed_label: "Rychlost blikání (1–10 za sekundu)",
  editor_port_led_blink_hint: "Pouze volitelný vizuální efekt. Stav portů, detekce provozu a ovládání zůstávají beze změny.",
