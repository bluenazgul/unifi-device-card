...
const TRANSLATIONS = {
  ...
  de: {
    ...
    editor_custom_special_ports_hint:  "Mehrfachauswahl für Ports in der oberen Spezial-Reihe. Gewählte Ports werden aus dem normalen Grid entfernt.",
  ...
  fr: {
    ...
    editor_custom_special_ports_hint:  "Sélection multiple de ports pour la ligne spéciale supérieure. Les ports sélectionnés sont retirés de la grille normale.",
