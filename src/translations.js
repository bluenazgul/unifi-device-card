...
const TRANSLATIONS = {
  ...
  de: {
    ...
    editor_ports_per_row_hint:  "Nur für Switches. Leer lassen für automatisches Layout oder Zahl setzen (z. B. 4, 6, 8, 12).",
  ...
  fr: {
    ...
    editor_ports_per_row_hint:  "Uniquement pour les switches. Laissez vide pour la mise en page automatique ou définissez un nombre (ex. 4, 6, 8, 12).",
  ...
  es: {
    ...
    editor_ports_per_row_hint:  "Solo para switches. Déjalo vacío para diseño automático o define un número (p. ej. 4, 6, 8, 12).",
