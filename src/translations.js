...
const TRANSLATIONS = {
  en: {
    ...
    editor_ap_ports_toggle_label: "AP switch ports",
    editor_ap_ports_toggle_text:  "Show detected AP switch ports",
    editor_ap_ports_toggle_hint:  "For in-wall access points with detected ports. Disable to keep the classic AP-only card.",
  ...
  de: {
    ...
    editor_ap_ports_toggle_label: "AP-Switch-Ports",
    editor_ap_ports_toggle_text:  "Erkannte AP-Switch-Ports anzeigen",
    editor_ap_ports_toggle_hint:  "Für In-Wall-Access-Points mit erkannten Ports. Deaktivieren zeigt weiterhin nur die klassische AP-Karte.",
