...
- Add a dedicated, scalable HTML-rendered device design and combined view for legacy and current UniFi In-Wall APs while keeping other access points round; discovered integrated switch ports and their actions/details remain optional.
