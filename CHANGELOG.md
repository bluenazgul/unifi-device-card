...
- Add a dedicated HTML-rendered device design and combined view for UAP AC In-Wall, U6 In-Wall, U6 Enterprise In-Wall, and U7 In-Wall while keeping other access points round; discovered integrated switch ports and their actions/details remain optional.
